...
const ModalEditSkill = ({ editableSkill, onClose, onSave }) => {
  const [updatedSkill, setUpdatedSkill] = useState({ ...editableSkill });
  ...
  useEffect(() => {
    setUpdatedSkill({ ...editableSkill });
  }, [editableSkill]);

  const handleInputChange = (key, value) => {
    setUpdatedSkill((prevData) => ({ ...prevData, [key]: value }));
  };
            ...
            <div className="inline-block align-middle p-8 my-8 text-left bg-white shadow-xl transform transition-all sm:my-16 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="py-2">
                ...
                <select
                  ...
                  value={updatedSkill.category_id}
                  onChange={(e) =>
              ...
              <div className="modal-action">
                <button className="btn" onClick={() => onSave(updatedSkill)}>
                  Save
                </button>
