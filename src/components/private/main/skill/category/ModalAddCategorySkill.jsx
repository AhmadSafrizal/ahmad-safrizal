...
const ModalAddCategorySkill = ({ onClose, onSave }) => {
  const [newCategorySkill, setNewCategorySkill] = useState({
    name: "",
  });

  const handleInputChange = (key, value) => {
    setNewCategorySkill((prevData) => ({ ...prevData, [key]: value }));
  };
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            <div className="inline-block align-middle p-8 my-8 text-left bg-white shadow-xl transform transition-all sm:my-16 sm:align-middle sm:max-w-lg sm:w-full">
              <h3 className="font-bold text-lg">Add Category Skill</h3>
              <div className="py-2">
              ...
              <div className="modal-action">
                <button
                  className="btn"
                  onClick={() => onSave(newCategorySkill)}
                >
                  Save
                </button>
...
export default ModalAddCategorySkill;
